...
import { api, type MovieProject, type MovieProviderReadiness, type Project } from "@/lib/api";
...
export function MovieStudioView() {
  ...
  function reset() { setSaved(null); setError(""); setForm((current) => ({ ...current, title: "", description: "", additionalInstructions: "" })); }
