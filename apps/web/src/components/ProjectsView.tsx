...
export function ProjectsView() {
  ...
  return <div className="projects-page">
    ...
    <div className="workspace-banner"><span className="workspace-banner-icon"><BriefcaseBusiness size={18} /></span><div><small>{workspaceTypeLabel}</small><strong>{workspace?.name}</strong></div><span className="workspace-role">{workspaceRoleLabel}</span></div>
