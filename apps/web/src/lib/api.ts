...
export type MovieProductionExecution = { generationJobId: string; jobType: string; status: GenerationJobStatus; progressPercent: number; retryCount: number; attemptCount: number; qualityControlStatus: "Passed" | "Failed" | "Pending" | "NotRecorded" | string; errorCode: string | null; errorMessage: string | null; assetId: string | null; assetType: string | null; attempts: MovieProductionProviderAttempt[] };
...
export type MovieShotProduction = { movieShotId: string; currentStage: MovieProductionStage; versions: MovieProductionVersion[]; transitions: MovieProductionStageTransition[]; takes: MovieTake[] };
