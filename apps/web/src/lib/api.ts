...
export type MovieGuide = { id: string; visualLanguage: string; cameraLanguage: string; colorAndLighting: string; soundAndNarration: string; continuityRules: string; updatedAt: string; currentRevisionNumber?: number; lockedRevisionNumber?: number | null; lockedAt?: string | null };
...
export type MovieShot = { id: string; sequence: number; description: string; cameraAndFraming: string | null; cameraMotion: string | null; durationSeconds: number | null; narration: string | null; dialogue: string | null; visualContinuityNotes: string | null; productionStage: MovieProductionStage; clips: MovieClip[]; productionVersions: MovieProductionVersion[] };
