...
export type DirectorAction = { id: string; proposalId: string; actionType: string; status: string; approvalRequired: boolean; failureCode: string | null; createdAt: string; approvedAt: string | null; startedAt: string | null; completedAt: string | null; results: DirectorActionResult[] };
export type DirectorProposal = { id: string; movieProjectId: string; status: string; title: string; summary: string; rationale: string[]; plan: DirectorPlanItem[]; actions: DirectorAction[]; createdAt: string; approvedAt: string | null };
