...
export type MovieProjectShell = Pick<MovieProject, "id" | "workspaceId" | "projectId" | "mode" | "status" | "title" | "description" | "durationSeconds" | "aspectRatio" | "style" | "language" | "additionalInstructions" | "createdAt" | "updatedAt">;
