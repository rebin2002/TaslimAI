...
export type MovieShotProduction = { movieShotId: string; currentStage: MovieProductionStage; versions: MovieProductionVersion[]; transitions: MovieProductionStageTransition[]; worldContinuity?: MovieWorldContinuitySnapshot | null };
